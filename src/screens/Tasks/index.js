...
import { View, Text, Modal, SafeAreaView, ScrollView,TouchableOpacity, Keyboard, Alert, FlatList, ActivityIndicator, Platform } from 'react-native';
...
export default function Tasks() {
  ...
  function handleSubmit() {
    ...
    Alert.alert('Confirmando dados:',
                `Tipo: ${type} - Matéria: ${subject} - Série: ${grade} - Tarefa: ${work} - Data e hora: ${date} até ${hour}`,
                [
                  {
                    text: 'Cancelar',
                    style: 'Cancel'
